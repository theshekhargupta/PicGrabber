...
class PGConstant {
    static let api_key = "084c2949e944f7084d840344f4a99d42"
    static let per_page = 60
    static let searchURL = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(PGConstant.api_key)&format=json&nojsoncallback=1&safe_search=1&per_page=\(PGConstant.per_page)&text=%@&page=%ld"
    static let imageURL = "https://farm%d.staticflickr.com/%@/%@_%@_\(PGConstant.size.url_s.value).jpg"
